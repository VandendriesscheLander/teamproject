...
class VoiceDBRecord extends FirestoreRecord {
  ...
  String get originalQuestion => _originalQuestion ?? '';
  bool hasOriginalQuestion() => _originalQuestion != null;
  ...
  void _initializeFields() {
    ...
    _originalQuestion = snapshotData['originalQuestion'] as String?;
  }
...
class VoiceDBRecordDocumentEquality implements Equality<VoiceDBRecord> {
  ...
  bool equals(VoiceDBRecord? e1, VoiceDBRecord? e2) {
    ...
    return e1?.question == e2?.question &&
        ...
        e1?.originalQuestion == e2?.originalQuestion;
  }
